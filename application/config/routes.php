...
$route['prepare_client_transaction/validate'] = 'dashboard/prepare_client_transaction_process';
...
// $route['say/hi'] = 'main/say';
// $route['say_anything/(:any)'] = 'main/say_anything/$val';
// $route['danger'] = 'main/danger';
// $route['ninjas/(:any)'] = 'main/ninjas/$1';
// $route['say/(:any)/(:any)'] = 'users/say/$value/$number';
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE; 
